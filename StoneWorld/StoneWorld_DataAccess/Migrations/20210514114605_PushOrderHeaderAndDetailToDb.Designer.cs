...
namespace StoneWorld_DataAccess.Migrations
{
    ...
    [Migration("20210514114605_PushOrderHeaderAndDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoneWorld_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneWorld_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneWorld_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneWorld_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StoneWorld_Models.InquiryDetail", b =>
                {
                    b.HasOne("StoneWorld_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StoneWorld_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("StoneWorld_Models.InquiryHeader", b =>
                {
                    b.HasOne("StoneWorld_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StoneWorld_Models.OrderDetail", b =>
                {
                    b.HasOne("StoneWorld_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("StoneWorld_Models.OrderHeader", b =>
                {
                    b.HasOne("StoneWorld_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
