...
namespace StoneWorld.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(IWebHostEnvironment webHostEnvironment, IEmailSender emailSender, IProductRepository prodRepo, 
            IApplicationUserRepository appUserRepo, IInquiryHeaderRepository inqHRepo, IInquiryDetailRepository inqDRepo)
        {
        ...
        public IActionResult Index()
        {
            ...
            IEnumerable<Product> prodListTemp = _prodRepo.GetAll().Where(u => prodInCart.Contains(u.Id));
        ...
        public IActionResult Summary()
        {
            ...
            List<int> prodInCart = shoppingCartList.Select(i => i.ProductId).ToList();
            IEnumerable<Product> prodList = _prodRepo.GetAll().Where(u => prodInCart.Contains(u.Id));
